...
type AgentConn interface {
	...
	FindSemanticSymbols(ctx context.Context, req SemanticFindSymbolsRequest) (SemanticFindSymbolsResponse, error)
	FindSemanticReferences(ctx context.Context, req SemanticFindReferencesRequest) (SemanticFindReferencesResponse, error)
	FindSemanticImplementations(ctx context.Context, req SemanticFindImplementationsRequest) (SemanticFindImplementationsResponse, error)
	GetSemanticDiagnostics(ctx context.Context, req SemanticDiagnosticsRequest) (SemanticDiagnosticsResponse, error)
