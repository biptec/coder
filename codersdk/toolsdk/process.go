...
Use the process_id returned by coder_workspace_bash. This tool can wait briefly for more output or process exit, then returns the current state. The process itself is independent of this request and keeps running if this tool call disconnects.
		...
		Schema: aisdk.Schema{
			Properties: map[string]any{
				...
				"process_id": map[string]any{
					"type":        "string",
					"description": "Tracked process ID returned by coder_workspace_bash or coder_workspace_process_list.",
				},
