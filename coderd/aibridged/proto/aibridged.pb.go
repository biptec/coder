...
type AIProviderKindBedrock struct {
	...
	// endpoint selects the Bedrock transport ("invoke-model" or "mantle").
	// Empty means invoke-model.
...
func (x *AIProviderKindBedrock) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
var file_coderd_aibridged_proto_aibridged_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74,
