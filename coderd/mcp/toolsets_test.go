...
func TestDeveloperToolAliases(t *testing.T) {
	...
	expected := map[string]string{
		...
		toolsdk.ToolNameWorkspaceRemoteHosts:     "remote_hosts",
		...
		toolsdk.ToolNameWorkspaceHTTPRequest:     "http_request",
		toolsdk.ToolNameWorkspaceGitQuery:        "git_query",
		toolsdk.ToolNameWorkspaceGitMutate:       "git_mutate",
...
func TestReadonlyToolAliases(t *testing.T) {
	...
	allowed := map[string]struct{}{
		...
		toolsdk.ToolNameWorkspaceRemoteHosts:     {},
		...
		toolsdk.ToolNameWorkspaceGitQuery:        {},
