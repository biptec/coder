...
// ReportCommandActivity RPC for durable workspace command history.
type DRPCAgentClient211 interface {
	DRPCAgentClient210
	ReportCommandActivity(ctx context.Context, in *ReportCommandActivityRequest) (*emptypb.Empty, error)
}
