...
func (c *drpcAgentClient) ReportCommandActivity(ctx context.Context, in *ReportCommandActivityRequest) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/coder.agent.v2.Agent/ReportCommandActivity", drpcEncoding_File_agent_proto_agent_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCAgentServer interface {
	...
	ReportCommandActivity(context.Context, *ReportCommandActivityRequest) (*emptypb.Empty, error)
...
func (s *DRPCAgentUnimplementedServer) ReportCommandActivity(context.Context, *ReportCommandActivityRequest) (*emptypb.Empty, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCAgentDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 13:
		return "/coder.agent.v2.Agent/ReportCommandActivity", drpcEncoding_File_agent_proto_agent_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCAgentServer).
					ReportCommandActivity(
						ctx,
						in1.(*ReportCommandActivityRequest),
					)
			}, DRPCAgentServer.ReportCommandActivity, true
	case 14:
...
type DRPCAgent_ReportCommandActivityStream interface {
	drpc.Stream
	SendAndClose(*emptypb.Empty) error
}

type drpcAgent_ReportCommandActivityStream struct {
	drpc.Stream
}

func (x *drpcAgent_ReportCommandActivityStream) SendAndClose(m *emptypb.Empty) error {
	if err := x.MsgSend(m, drpcEncoding_File_agent_proto_agent_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
