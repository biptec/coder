...
| `workspace_volume_copy_enabled`       | boolean                                                 | false    |              | Workspace volume copy enabled controls whether the dashboard offers the administrative persistent-volume copy workflow.                         |
...
| Name                       | Type                                                                                    | Required | Restrictions | Description |
|----------------------------|-----------------------------------------------------------------------------------------|----------|--------------|-------------|
| `allow_source_running`     | boolean                                                                                 | false    |              |             |
| `destination_workspace_id` | string                                                                                  | false    |              |             |
| `volumes`                  | array of [codersdk.WorkspaceVolumeCopySelection](#codersdkworkspacevolumecopyselection) | false    |              |             |
...
| `workspace_volume_copy_enabled`                | boolean                                                                                              | false    |              |                                                                    |
| `workspace_volume_copy_image`                  | string                                                                                               | false    |              |                                                                    |
| `workspace_volume_copy_namespace`              | string                                                                                               | false    |              |                                                                    |
...
| Value(s)                                                                                                                                                                                                                                      |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `application_connect`, `assign`, `create`, `create_agent`, `delete`, `delete_agent`, `read`, `read_personal`, `share`, `ssh`, `start`, `stop`, `unassign`, `update`, `update_agent`, `update_personal`, `use`, `view_insights`, `volume_copy` |
...
| `id`                       | string                                                                                  | false    |              |             |
| `initiator_id`             | string                                                                                  | false    |              |             |
| `source_workspace_id`      | string                                                                                  | false    |              |             |
| `started_at`               | string                                                                                  | false    |              |             |
| `status`                   | [codersdk.WorkspaceVolumeCopyStatus](#codersdkworkspacevolumecopystatus)                | false    |              |             |
| `sync_of`                  | string                                                                                  | false    |              |             |
| `updated_at`               | string                                                                                  | false    |              |             |
| `volumes`                  | array of [codersdk.WorkspaceVolumeCopySelection](#codersdkworkspacevolumecopyselection) | false    |              |             |
...
| Value(s)                                                |
|---------------------------------------------------------|
| `canceled`, `failed`, `pending`, `running`, `succeeded` |
...
| `display_name`   | string          | false    |              |             |
| `excluded_paths` | array of string | false    |              |             |
| `key`            | string          | false    |              |             |
